...
public class ConnectionTest {
    ...
    public static void main(String[] args) throws Exception {
        new ConnectionTest().getConnection5();
    }
    ...
    public void ConnectionTest1() throws SQLException {
        ...
        //url:gttp://localhost:8080/gmail/keyboard.jpg
        //jdbc:mysql:协议
        //localhost：IP地址
        //3306：默认mysql的端口号
        //test：test数据库
        ...
        info.setProperty("password", "yp010522");
    ...
    //方式二：对方式一的迭代:在以下的程序中不出现第三方的aqi，是的程序具有更好的可移植性
